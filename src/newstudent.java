...
public class newstudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 390, -1, -1));
        ...
        getContentPane().add(jButton8, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 490, 120, 30));

        jTextField1.setFont(new java.awt.Font("Avenir", 0, 12)); // NOI18N
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 230, 200, -1));

        jTextField2.setFont(new java.awt.Font("Avenir", 0, 12)); // NOI18N
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 270, 200, -1));

        jTextField3.setFont(new java.awt.Font("Avenir", 0, 12)); // NOI18N
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 310, 200, -1));

        jLabel9.setFont(new java.awt.Font("Avenir", 0, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Year/Sem     :");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 430, -1, -1));

        jComboBox1.setFont(new java.awt.Font("Avenir", 0, 12)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "B.Tech.", "M.Tech.", "B.Sc.", "M.Sc.", "BCA", "BBA", "MBA" }));
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 350, 200, -1));

        jTextField4.setFont(new java.awt.Font("Avenir", 0, 12)); // NOI18N
        getContentPane().add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 390, 200, -1));

        jComboBox2.setFont(new java.awt.Font("Avenir", 0, 12)); // NOI18N
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1yr / 1st sem", "1yr / 2nd sem", "2yr / 3rd sem", "2yr / 4th sem", "3yr / 5th sem", "3yr / 6th sem", "4yr / 7th sem", "4yr / 8th sem" }));
        getContentPane().add(jComboBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 430, 200, -1));
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        String sql = "Insert into Student (StudentID, StudentName, fathername, course, branch, sem) values (?,?,?,?,?,?)";
        try{
